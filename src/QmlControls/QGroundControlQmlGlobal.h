...
public:
    ...
    //Mismart: for render plan

    Q_PROPERTY(FlightHubManager* flightHubManager READ flightHubManager CONSTANT)
    ...
    FlightHubManager* flightHubManager(void) const  {return _flightHubManager;}
#if defined(QGC_ENABLE_PAIRING)
